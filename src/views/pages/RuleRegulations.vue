<template>
  <div class="block relative text-sm w-full py-1">
    <div
      class="rule __bg-white block relative text-sm w-full md:w-10/12 px-3 py-3 m-auto font-cera-round-pro"
    >
      <div class="rules-regs">
        <h1 class="font-bold text-xl">THE SITE RULES AND REGULATIONS</h1>
        <div class="intro">
          <h2 class="text-lg font-semibold">PART A - INTRODUCTION</h2>
          <h3 class="text-lg font-semibold">1. Use and interpretation</h3>
          <p>
            These Rules and Regulations ("<b>Rules</b>") are part of the Site's
            <span></span>terms and conditions.
          </p>
          <p>
            The Rules apply to all bets placed on this online betting platform
            ("<b>Site</b>"). The Rules consist of the following:
          </p>
          <ul>
          ...
          <h3 class="text-lg font-semibold">2. Customer responsibility</h3>
          <ul>
            <li>
        ...
        <div class="general">
          <h2 class="text-xl font-semibold">PART B - GENERAL RULES</h2>
          <h3 class="text-lg font-semibold">
            1. Matters beyond the Site's reasonable control and malfunctions
          </h3>
          <p>
          ...
          <h3 class="text-lg font-semibold">2. Managing markets In-Play</h3>
          ...
          <ul>
            <li>
              ...
              does not guarantee that such markets will be suspended and turned
            ...
            <li>
              ...
              turned in-play at a later time during the event, all bets matched
              after the time of the 'off' will stand.
            </li>
          </ul>
            ...
            <li>
              ...
              <ol class="roman">
                ...
                <li>
                  ...
                  scheduled time of the kick-off and before the first "Material
                  Event" will stand. However, if there has been one or more
                  "Material Events", any bets matched between the first
                  "Material Event" and the market being turned in-play will be
                  void.
                </li>
              </ol>
            </li>
            ...
            <li>
              ...
              <ol class="roman">
                <li>
                  ...
                  a goal being scored, a penalty being awarded or a player being
                  sent off.
                </li>
              </ol>
            </li>
          ...
          <h3 class="text-lg font-semibold">5. Resettlements</h3>
          <ul>
            <li>
              ...
              winnings of that customer on a given market) purely as a customer
              service benefit. However, the Site reserves the right to amend the
              settlement of the market if: (i) the official result is different
              to the result on which the Site initially settled the market; or
          ...
          <ul>
            <li>
              Subject always to the Site's right to void bets under its terms
          ...
          <ul>
            <li>
              ...
              named in a 'Winner with …' market title does not participate in
              the tournament or event then all bets on the market will be void.
            </li>
            <li>
          ...
          <h3 class="text-lg font-semibold">9. Change of venue</h3>
          <p>
            Some markets have different rules and these are listed in the
          ...
          <h3 class="text-lg font-semibold">10. Periods of time</h3>
          <p>
            Some markets have different rules and these are listed in the
          ...
          <p>
            ...
            mean the end of the day local time after the expiry of the specified
            number of days.
          </p>

          <h3 class="text-lg font-semibold">11. "To qualify" markets</h3>
          <p>
            Some markets have different rules and these are listed in the
            Specific Sports Rules. However, if not dealt with in the Specific
            Sports Rules then the following shall apply.
          ...
          <p>
            ...
            determined by the competitor or team that qualifies, whether or not
            they take part in the next round or event for which they have
            qualified. Markets will be settled after the qualifying stage and
            any subsequent disqualification or amendment to the result will not
            count.
          </p>

          <h3 class="text-lg font-semibold">12. Dead heats</h3>
          <p>
          ...
          <p>
            ...
            winners (i.e. stake multiplied by (number of winners expected/number
            of actual winners)). The winnings are then paid to the successful
          ...
          <h3 class="text-lg font-semibold">13. Miscellaneous</h3>
          <ul>
            <li>
            ...
            <li>
              ...
              any obvious error, then the Site reserves the right to suspend the
            ...
            <li>
              ...
              account if it considers that that customer has used the Site in an
          ...
          <h3 class="text-lg font-semibold">14. Multiple accounts</h3>
          <p>
          ...
          <p>
            ...
            accounts "linked" and managed accordingly which may affect the
          ...
          <h3 class="text-lg font-semibold">16. Cheating/Sniping</h3>
          <p>
          ...
          <p>
            ...
            court siding, sniping and commission abuse.
          </p>

          <h3 class="text-lg font-semibold">17. Integrity</h3>
          <p>
        ...
        <div class="specific">
          <h2 class="text-xl font-semibold">PART C - SPECIFIC SPORTS RULES</h2>
          <h3 class="text-lg font-semibold">1. Cricket</h3>
          <h4 class="text-lg">General</h4>
          <ul>
            <li>
          ...
          <h4 class="text-base font-semibold">Test matches</h4>
          <ul>
            <li>
              ...
              crowd protests/violence; stadium damage; acts of terrorism; and
              acts of God), the Site reserves the right to void all bets, except
          ...
          <h4 class="text-base font-semibold">Limited Over matches</h4>
          <ul>
            <li>
            ...
            <li>
              ...
              for a limited overs match all bets that were placed after 30
          ...
          <h4 class="text-base font-semibold">Completed Match</h4>
          <ul>
            <li>
              A match will be treated as "Completed" when the required number of
              overs for that game have been completed as determined by the match
              officials. If the required number of overs for that match has not
              been completed, the match will be treated as "Match Abandoned" or
              "No Result" and bets will be settled accordingly.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              ...
              <ol class="roman">
                <li>
                  If an innings is curtailed before the original scheduled start
                  of play, all bets will be settled.
                </li>
                <li>
                  If an innings is curtailed after start of play, then all bets
                  on markets for this event will be settled up to the stipulated
                  new innings length.
                </li>
              </ol>
            </li>
            <li>
              In any session market, in the event a session is not completed in
              full because a team is all out or declared, all bets will remain
              valid and the market will be settled at the innings score.
            </li>
            <li>
            ...
            <li>
              ...
              will be void should no more play take place following the
              intervention of rain, or any other delay, as the ability to reach
              previous quotes offered will have been removed. In case of rain,
            ...
            <li>
              ...
              with the exception of penalty runs awarded due to a slow over rate
          ...
          <h6 class="text-xs font-semibold">Test Matches</h6>
          <ul>
            <li>
          ...
          <h6 class="text-xs font-semibold">Limited Overs Matches</h6>
          <ul>
            <li>
              Limited Overs Matches - <b>(Player Meter)</b>, Individual Batsmen
              Runs or Partnerships - In a limited overs match where bets may be
              made on an individual batsman or partnership runs in-play and the
              ...
              resumes at a later time, a new market may be formed. If a customer
              wants a position in the new market they are required to place a
              new bet. If there are any subsequent reductions in overs, exactly
              the same rules will continue to apply i.e. the market is settled
              at the midpoint of the last available quote before the overs were
              reduced and a new market may be formed.
            </li>
            <li>
              Total Match Four,Total Match Sixes, Total Match Runs, Total Match
              Wides, Total Match Extras, Total Match Wicket, Top Batsmen,
            ...
            <li>
              ...
              that are yet to be determined will be void.
            </li>
          </ul>
          <h4 class="text-lg font-semibold">Exchange Runs</h4>
          <ul>
            <li>
            ...
            <li>
              ...
              <ol class="type-a">
                <li>
                  if the scheduled number of overs for the innings is reduced by
                  rain interruption and at settlement time, the actual number of
                  overs bowled is less than the number of overs stipulated for
                  the market; or
                </li>
                <li>
          ...
          <h3 class="text-lg font-semibold">Soccer</h3>
          <ul>
            <li>
              ...
              unfairly matched after the Material Event has occurred. Voiding of
              these bets may take place during the event or retrospectively once
              a game is completed.
            </li>
            <li>
              ...
              three days of its original start date.
            </li>
            <li>
              If a match starts but is later abandoned or postponed and the Site
            ...
            <li>
              ...
              friendly match starts but is later abandoned or postponed and is
            ...
            <li>
              ...
              'XI' in the name). If an official fixture is shown on the Site
              under an incorrect competition name, then the Site reserves the
            ...
            <li>
              ...
              league game has been played. For the purposes of this rule,
            ...
            <li>
              ...
              example, if a player joins a club mid-season any goals scored in a
              different league will not count, however goals scored for a
              different club in the same league will count. Own goals will not
              count.
            </li>
            <li>
              In markets which relate to the number of incidents to occur, such
              as 'number of corners', these will be determined on the basis of
              the number taken, rather than awarded.
            </li>
            <li>
          ...
          <h3 class="text-lg font-semibold">Tennis</h3>
          <h4 class="text-base font-semibold">General / Exchange Markets</h4>
          <ul>
            <li>
              ...
              the tournament in the case of a final) will be deemed the winner.
            ...
            <li>
              ...
              after the market has been loaded, provided that the match has been
          ...
          <h4 class="text-lg font-semibold">Fancy Markets</h4>
          <h5 class="text-base font-semibold">
            Retirement or Disqualification:
          </h5>

          <h6 class="text-xs font-semibold">1. Head to Head Matchups:</h6>
          <ul>
            <li>
              One full set must be completed for Money Line wagers to stand. If
              less than 1 set is completed, all Money Line wagers will be
              ...
              <span class="example"
                ...
                forced to retire due to injury (or disqualification). All money
                line wagers stand. Nadal is declared the winner while Djokovic
                is deemed the loser. All other bets on the Spread, total, team
                total and sets betting will be void regardless of current
                score.</span
              >
            </li>
            <li>
              If a player retires before the 1st set is completed, all wagers on
              the match will be considered void.
              <span class="example"
                >Example: Nadal leads 2-0 vs Djokovic who retires due to injury.
                All wagers considered void.</span
              >
            </li>
          </ul>
          <h6 class="text-xs font-semibold">2. First Set Betting:</h6>
          <ul>
            <li>
          ...
          <h6 class="text-xs font-semibold">3. Sets Betting: (Set Handicap)</h6>
          <ul>
            <li>
              If a tennis match is not completed because of a player retirement
              or disqualification, all Set betting wagers will be considered
              void. Such wagers will be cancelled and the monies refunded.
              <span class="example"
                >Example: If we offer Player A (-1.5 sets or -2.5 sets) vs
                Player B (+1.5 sets or +2.5 sets) the match must be completed.
                If the match is not completed, wagers on that line are void. If
                we offer Player A to win exactly 2 sets to 1 or Player B to win
                exactly 2 sets to 1, those lines would be cancelled and refunded
                in the case of a retirement as well.</span
              >
            </li>
          </ul>
          ...
          <ul>
            <li>
              If a tennis match is not completed because of a player retirement
              or disqualification, all Handicap and Total Games bets will be
              considered void, regardless of the score of the match. Such wagers
          ...
          <ul>
            <li>
              If a tennis match is not completed because of a player retirement
              or disqualification, all proposition wagers will be considered
              void. Such wagers will be cancelled and the monies refunded, with
              some exceptions pertaining to propositions that require the
              completion of an individual set.
              <span class="example"
                >Example: To Win 1st Set (Must Complete 1st Set)</span
              >
            </li>
          </ul>
          <h6 class="text-xs font-semibold">
          ...
          <ul>
            <li>
              If a match ends with a player retirement, the team total bets for
              each individual player will be voided and graded as no action. A
              match must be completed for team total bets to be graded as
              action.
            </li>
            <li>
              If one of the players does not start the match, or tournament, all
              team total bets associated with that match will be graded as no
              action.
            </li>
          </ul>

          <h5 class="text-sm font-semibold">Delay or Suspension:</h5>
          <ul>
            <li>
              If a tennis match is completed, without retirement or
              disqualification, all wagers stand as written. A delay in the
              start of a match will not affect the standing of wagers, nor will
              a suspension, as long as play is resumed and the match completed.
            </li>
          </ul>

          <h5 class="text-sm font-semibold">Pro Set:</h5>
          <ul>
            <li>
              If a match is decided on a Pro Set, instead of the normal length
              of the match, all wagers are refunded except wagers on the 1st set
              line.
            </li>
            <li>
              If a match plays with a super tie-break as or is switched to
              having a super tie-break, then all wagers will be refunded on that
              match except for the 1st set winner and money line winner. The 1st
              set winner will have action and will be graded as normal.
            </li>
          </ul>
          ...
          <h5 class="text-sm font-semibold">Davis and Federation Cup:</h5>
          <ul>
            <li>
              All bets stand regardless of any change of venue, court surface,
              changing from indoors to outdoors and vice versa.
              <span class="example"
                ...
                refunded except wagers on the 1st set winner line.</span
              >
            </li>
          </ul>

          <h5 class="text-sm font-semibold">
            Live Betting (All pre-game rules apply to live wagering in addition
            to):
          </h5>
          <ul>
            <li>
              The next point must be played for wagers to have action. If either
              player retires before the next point is played, all wagers taken
              since the last point are refunded.
            </li>
            <li>
              If the first set is not completed, all bets on the outcome of the
              match (spread, money line, next set and total) will be void. All
              bets on a specific game will stand, provided that game was
            ...
            <li>
              ...
              completed because of a player retirement or disqualification, all
              live wagers on Handicap and Total Games will be voided. The wagers
              will be cancelled and the monies refunded. Note this also applies
              to live wagers on lines such as: Rafael Nadal to win Set 2 or
              Novak Djokovic to win Set 3.
            </li>
            <li>
              When betting on an individual game, only the score of that
              specific game is taken into consideration to determine the winner
              of the game. If the stated game is not completed, all live wagers
              on the game will be voided.
              <span class="example"
                >For example, when wagering on A. Murray Game 5 of Set 1, the
                winner of game 5 will determine the winner of this bet.</span
              >
            </li>
            <li>
          ...
          <h3 class="text-lg font-semibold">4. Greyhound racing</h3>
          <ul>
            <li>
            ...
            <li>
              ...
              form of an announcement or by display. Subsequent
            ...
            <li>
              ...
              to the update of the market on the Site will be void and all
              unmatched bets including 'Take SP' and 'keep' bets will be
              cancelled (except for certain SP bets as set out in Paragraph 10.5
              of Part B above).
            </li>
            <li>
            ...
            <li>
              ...
              by the Site, all bets will be void.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              ...
              removed and all bets on the market, matched prior to the update of
              the market on the Site, will be voided.
            </li>
            <li>
              If, following the completion of a race, the stewards declare a
              greyhound a non-runner, the Site will resettle the market and will
              void all bets that were placed on that runner only. The Site will
              then apply a reduction factor to all bets placed on the winner (or
              placegetters in the case of place markets) based on that runner's
              weighted average price.
            </li>
          </ul>
          <h3 class="text-lg font-semibold">5. Horseracing</h3>
          <h4 class="text-base font-semibold">General</h4>
          <ul>
            <li>
            ...
            <li>
              Horseracing Exchange Multiples are based on the Site's 'day of the
              race' markets (and not the Site's ante-post markets). The Site's
              horseracing ante-post rules do not therefore apply in relation to
              horseracing Exchange Multiples.
            </li>
          </ul>
          <h4 class="text-base font-semibold">The Site Non-Runner Rule</h4>
          <ul>
            <li>
              The Site's non-runner rule relates to the adjustment of odds on
              ...
              are described below) of that horse's chances of winning (or being
              placed, etc as appropriate) and is applied to bets already matched
              on the other runners in the relevant market or markets.
            </li>
            <li>
            ...
            <li>
              ...
              percentage. These reduction factors may be updated periodically at
              the discretion of the Site based on trading in the market, but
              after approximately 15 minutes (approximately 5 minutes for
            ...
            <li>
              ...
              non-runner or a highly likely non-runner, following a statement to
              the press from connections, the following will happen:
              <ul>
                <li>
                ...
                <li>
                  ...
                  the non-runner's final reduction factor and all the unmatched
                  offers to lay will be cancelled. If the non-runner's reduction
            ...
            <li>
              ...
              error (or, for example, there is a false start), all bets matched
              during this time will be subject to any later reduction factor,
              provided the market is turned out of play before the race
              commences. In the event of a late withdrawal, the Site reserves
            ...
            <li>
              ...
              following incorrect information regarding a runner's
              participation, the Site will reinstate both the runner and all
              previously matched bets associated with that runner. All bets made
              between the time of withdrawal and reinstatement will be void in
              both the place market and the win market. The reduction factor
              applied to matched bets at the time of withdrawal will be reversed
              and the original prices will become valid.
            </li>
            <li>
              Any non-runners will be removed from the relevant markets in the
              order in which they are brought to the Site's attention. If the
            ...
            <li>
              ...
              determined that the missing runner is not a material runner (i.e.
              a selection with a reduction factor of approx. 2.5% or less in the
              ...
              However, if the missing runner is deemed to be a material runner,
              then the malformed market will be void and a new market will be
          ...
          <ul>
            <li>
              ...
              <span class="example"
                ...
                subsequently declared a non-runner.</span
              >
              <span class="example"
                >For example: if the non-runner's final reduction factor is 25%
                the traded price on all previously matched bets on other horses
                will be reduced by 25% - - traded price of 8.0 would become 6.0.
                If the each Way terms were 1/5th odds for 3 places, the
                corresponding price for the Place portion of the bet would
                reduce from 2.4 to 2.0.</span
              >
            </li>
            <li>
              ...
              <span class="example"
                ...
                would become 6.25.</span
              >
              <span class="example"
                >For example a £10 bet on a horse to be placed at a traded price
                of 8.0 would provide winnings of £70. If there is a non-runner
                with a reduction factor of 25% in the race, that factor will be
                applied to the £70 of potential winnings leaving potential
                winnings of £52.50. Therefore the revised traded price will be
                6.25.</span
              >
            </li>
            <li>
            ...
            <li>
              ...
              will have a non-applicable reduction factor until the Site has
              received confirmation that it is a confirmed runner, in which case
              an applicable reduction factor may apply to it.
            </li>
            <li>
              ...
              markets of such non-runner by the Site. Likewise, should a reserve
              runner become a confirmed runner but subsequently become a
              non-runner, any reduction factor applicable to such non-runner
              will be applied to all bets struck on the relevant markets, prior
              to the removal from those markets of such non-runner by the Site.
            </li>
          </ul>
          <h4 class="text-base font-semibold">Additional rules</h4>
          <ul>
            <li>
            ...
            <li>
              ...
              non-runner for betting purposes. Should this result in the number
              of possible winners stated in the relevant Market Information
              being equal to or greater than the number of runners in the
              relevant Site market, all bets in the market will be void.
            </li>
          </ul>
        </div>
      </div>
