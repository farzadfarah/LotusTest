  ...
  <div class="p-body">
    <header id="header" class="d-flex align-items-center">
      <div class="container d-flex flex-column align-items-center">
        <h1>Coming Soon</h1>
        <h2>
          Our casino page is under construction!
        </h2>
...
export default {
  ...
  data() {
    return {
      endDate: new Date().setDate(new Date().getDate() + 24),
      now: new Date(),
      timer: null,
    };
  },
...
//@import url("UnderConstruction.css");
...
.p-body {
  color: #fff;
  background: url("../../../assets/images/bg03.jpg") top center no-repeat;
